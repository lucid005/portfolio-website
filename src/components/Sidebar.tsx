  ...
  return (
    <>
      ...
      <div className="xl:hidden flex items-center justify-between px-2 sm:px-5 py-5">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="text-gray-700 focus:outline-none bg-white p-1 border rounded-sm">
            <Menu size={24} />
          </button>
          <ModeToggle />
        </div>
      ...
      <div
        ...
        } xl:translate-x-0 transition-transform duration-200 ease-in-out w-[250px] h-full bg-white xl:bg-[#f9f9f9] z-40`}>
        <div className="w-full h-full px-4 space-y-8 mt-6">
          <div className="flex items-center gap-2">
            <Image
              src={"/Profile.jpg"}
              width={40}
            ...
            <nav>
              {navLinks.map((link, index) => (
                <button
                  ...
                  className={`flex items-center text-gray-700 text-sm font-medium rounded-[8px] w-full px-3 py-2 gap-2 cursor-pointer hover:text-black transition-colors duration-200 ${
